...
document.addEventListener('DOMContentLoaded', function() {
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        formValues.userAgent = navigator.userAgent;
        formValues.pageUrl = window.location.href;

        // Send to webhook
        fetch('https://hook.eu2.make.com/tzuxaacqqhhcj44vc7tkqu384aukfef6', {
            method: 'POST',
            headers: {
        ...
        .then(response => {
            ...
            // Skip JSON parsing since webhook may not return JSON
            return response;
        })
        .then(() => {
